...
adr="http://127.0.0.1:15152/xeoma?title=drone2-1" # username, passwd, etc.
clientports=[15152,60785] # the client ports we are going to use for receiving video
...
s.connect((ip,15152)) # RTSP should peek out from port 554
...
print("ip %s, serverports %s" % ip,serverports)
