...
ip="172.19.1.10" # IP address of your cam
adr="rtsp://172.19.1.10/user=admin_password=tlJwpbo6_channel=1_stream=0.sdp?real_stream" # username, passwd, etc.
...
rn=500000 # receive this many packets
...
def digestpacket(st):
  ...
  bc+=8; lc+=1; # let go to "Second byte"
